...
# Base directory of the project (go up from back/services/ to project root)
...
# Results directory (metrics, reports)
...
def ensure_directories():
    ...
    directories = [DATA_DIR, INPUT_DIR, OUTPUT_DIR, MODELS_DIR, RESULTS_DIR]
